...
def filter_by_course(student_list: list, course: str) -> list:
    ...
    """
    return [x for x in student_list if course in x.courses]
...
def succeeding_students(student_list: list) -> list:
    ...
    """
    return list(itertools.filterfalse(is_failing, student_list))
...
def failing_students(student_list: list) -> list:
    ...
    """
    return list(filter(is_failing, student_list))
